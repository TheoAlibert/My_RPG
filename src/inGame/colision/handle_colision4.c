...
void check_to_changemap4(global_t *all, sfFloatRect playerRect)
{
...
void handle_colision4(global_t *all)
{
    ...
    sfFloatRect topBorder = {0, 0, mapWidth, 40};
    ...
    check_to_changemap4(all, playerRect);
